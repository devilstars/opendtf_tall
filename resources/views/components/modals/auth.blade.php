                            ...
                            <div class="w-full sm:w-2/3 p-5 tm-max-h-screen overflow-y-auto scroll-thin">
                                <form class="w-full" @keyup.enter="doAuth(request)">
                                    ...
                                    <div class="flex items-center justify-between">
                                        <button class="border-2 rounded-lg border-gray-300 bg-white hover:border-indigo-300 focus:border-indigo-500 focus:outline-none text-gray-800 font-semibold h-10 px-4  hover:text-indigo-500 whitespace-no-wrap focus:outline-none focus:shadow-outline"
                                                type="button">
                                            Войти
                                        </button>
                                        <a class="inline-block align-baseline font-bold text-sm text-gray-500 hover:text-indigo-800" href="#">
                                            Забыли пароль?
                                        </a>
                                    </div>
                                    <div class="flex items-center justify-center border-t pt-3 mt-3">
                                        <a class="inline-block align-baseline font-bold text-sm text-gray-500 hover:text-indigo-800" href="#" @click.prevent="mode = 1">
                                            Создать аккаунт
                                        </a>
                                    </div>
                                </form>
                        ...
                        <template v-if="mode === 1">
                            <div class="w-full sm:w-2/3 p-5 tm-max-h-screen overflow-y-auto scroll-thin">
                                <form class="w-full" @keyup.enter="doRegister(request)">
                                    ...
                                    <div class="flex items-center justify-center border-t pt-3 mt-3">
                                        <a class="inline-block align-baseline font-bold text-sm text-gray-500 hover:text-indigo-800" href="#" @click.prevent="mode = 0">
                                            Войти
                                        </a>
                                    </div>
                                </form>
